...
system_mv_folder() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código Connect Lead...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - root <<EOF
  cp "${PROJECT_ROOT}"/ConnectLead.zip /home/deploy/${instancia_add}/
EOF
...
#   None
#######################################
system_unzip_ConnectLead() {
  print_banner
  printf "${WHITE} 💻 Extraindo o Connect Lead...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - deploy <<EOF
  unzip /home/deploy/${instancia_add}/ConnectLead.zip -d /home/deploy/${instancia_add}
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema Connect Lead...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar uma Instância do Connect Lead...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Bloquear o Connect Lead...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o Connect Lead de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos alterar os domínios do Connect Lead de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
